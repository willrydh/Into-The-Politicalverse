...
export function UniversalSearch() {
  ...
  return <div className="universal-search">
    ...
    <div className="search-container search-coverage"><details><summary>{sv ? "Vad ingår i sökningen?" : "What does search cover?"}</summary><p>{sv ? "Sajtens sidor och innehåll, partier, val, daterad regeringskontext, personröstkandidater och valområden från riksdags-, region- och kommunvalen 2010–2026, 21 län, 290 kommuner, valdistrikt och uppsamlingsröster samt SCB:s 2 017 tätorter från 2023. Tätortsnamnen uppdaterades av SCB 24 november 2025." : "Site pages and content, parties, elections, dated government context, personal-vote candidates and areas from the 2010–2026 Riksdag, regional and municipal elections, 21 counties, 290 municipalities, districts and collection votes, plus Statistics Sweden's 2,017 urban localities from 2023. SCB updated the locality names on 24 November 2025."}</p><p>{sv ? "Orter och valdistrikt är olika geografiska områden. Ortträffar öppnar den eller de berörda kommunernas valresultat. Personröstträffar omfattar fastställda resultat. Nya valområden från 2026 läggs till när de är färdigräknade och kontrollerade. Småorter saknar namn i SCB:s aktuella register; lokala namn kan ändå hittas i valdistriktsnamnen." : "Localities and electoral districts are different geographic areas. Locality results open the relevant municipalities' election results. Personal-vote results cover final counts. New 2026 areas are added when counting and verification are complete. SCB's current smaller-locality register has no names; local names may still be found in electoral district names."}</p><a href="https://www.scb.se/hitta-statistik/statistik-efter-amne/boende-bebyggelse-och-mark/bebyggelseomraden/tatorter-och-smaorter/" target="_blank" rel="noreferrer">{sv ? "SCB: tätorter och småorter" : "Statistics Sweden: localities"} ↗</a></details></div>
  </div>;
}
