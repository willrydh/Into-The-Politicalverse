...
export function PreElectionArchive({ locale = "sv" }: { locale?: Locale } = {}) {
  ...
  return localizeNode((
    <>
      <section className="forecast-page-hero">
        <div className="forecast-page-hero__copy">
          ...
          <div className="forecast-page-hero__links">
            <a href="#archive-fragor">Börja med frågorna <span>↓</span></a>
            <a href="#archive-metod">Granska metod och källor <span>↓</span></a>
          </div>
        </div>
      ...
      <nav className="forecast-jump-nav" aria-label="Prognosens avsnitt">
        <div>
          <a href="#archive-fragor">Frågor</a>
          <a href="#archive-partier">Partier</a>
          <a href="#archive-regering">Regering</a>
          <a href="#archive-historik">Rörelse</a>
          <a href="#archive-backtest">Historiska test</a>
          <a href="#archive-metod">Metod & integritet</a>
        </div>
      </nav>

      <section className="product-section forecast-section" id="archive-fragor">
        <SectionHeading
      ...
      <section className="product-section forecast-section forecast-section--paper" id="archive-partier">
        <SectionHeading
      ...
      <section className="forecast-government-section" id="archive-regering">
        <div className="forecast-government-section__inner">
          ...
          <GovernmentFormation idPrefix="archive-" forecast={electionForecast} />
        </div>
      </section>

      <section className="product-section forecast-section" id="archive-historik">
        <SectionHeading
      ...
      <section className="product-section forecast-section forecast-section--paper" id="archive-backtest">
        <SectionHeading
      ...
      <section className="product-section forecast-section" id="archive-metod">
        <SectionHeading
