...
export function CandidateMethod() {
  ...
  return <details className="candidate-method"><summary>{sv?"Källor, kopplingar och beräkning":"Sources, identity links and calculation"}</summary>
    <p>{sv?"Officiella personröster från Valmyndigheten 2010–2026. För 2026 införs varje valområde när räkning, protokoll och mandat är fastställda; täckningen visas i urvalet. Originalarkiven 2010–2018 är bevarade hos Internet Archive; 2022 kommer direkt från Valmyndighetens samlade Excel-filer och 2026 från signerade JSON-filer. Kandidaternas valsedelslistor summeras inom rätt parti, val och område. Alla redovisade personröster ingår, även godkända utlandsröster i riksdagsvalet.":"Official personal votes from Valmyndigheten, 2010–2026. Each 2026 electoral area is added when its count, protocol and seats are final; coverage is shown with the selection. The original 2010–2018 archives are preserved by the Internet Archive; 2022 comes directly from Valmyndigheten’s combined Excel files and 2026 from signed JSON files. Ballot lists are summed within the correct party, election and area. All reported personal votes are included, including accepted overseas votes in the Riksdag election."}</p>
