...
export function CandidateMethod() {
  ...
  return <details className="candidate-method"><summary>{sv?"Källor, kopplingar och beräkning":"Sources, identity links and calculation"}</summary>
    <p>{sv?"Officiella personröster från Valmyndigheten 2010–2026. För 2026 visas verifierade personröster när områdets alla distrikt är räknade. Räknat och fastställt redovisas separat; täckningen visas i urvalet. Originalarkiven 2010–2018 är bevarade hos Internet Archive; 2022 kommer direkt från Valmyndighetens samlade Excel-filer och 2026 från signerade JSON-filer. Kandidaternas valsedelslistor summeras inom rätt parti, val och område. Alla redovisade personröster ingår, även godkända utlandsröster i riksdagsvalet.":"Official personal votes from Valmyndigheten, 2010–2026. Verified 2026 personal votes are shown once all districts in the area are counted. Counted and final results are labelled separately; coverage is shown with the selection. The original 2010–2018 archives are preserved by the Internet Archive; 2022 comes directly from Valmyndigheten’s combined Excel files and 2026 from signed JSON files. Ballot lists are summed within the correct party, election and area. All reported personal votes are included, including accepted overseas votes in the Riksdag election."}</p>
    ...
    <p>{sv?"Listplats är kandidatens tryckta plats på partiets valsedel, inte placeringen efter personröster eller mandatfördelning. Alla skilda listor och platser som källans personröstdata redovisar för kandidaten i området visas. Andra registrerade valsedlar kan saknas. Saknad uppgift ersätts inte med en gissad plats. En ändrad listplats och fler personröster visar ett samband i historiken, inte hur mycket listplatsen orsakade ökningen.":"List position is the candidate’s printed position on the party’s ballot, not their rank by personal votes or seat allocation. All distinct ballot lists and positions reported for the candidate in the area’s official personal-vote data are shown. Other registered ballot lists may be absent. Missing information is never replaced by a guessed position. A changed list position alongside more personal votes is an observation, not a measure of the position’s causal effect."}</p>
    ...
    <a href="https://www.val.se/valresultat-och-statistik/statistik-och-data/radata-val-2026" target="_blank" rel="noreferrer">Valmyndigheten ↗</a><span> · </span><a href={`${process.env.NEXT_PUBLIC_BASE_PATH ?? ""}/api/candidates/index.json`}>{sv?"Källmanifest och täckning":"Source manifest and coverage"} ↗</a><p className="local-note">{sv?"OFFICIELLA röster · BERÄKNAD historik och förändring":"OFFICIAL votes · DERIVED history and changes"} · {CANDIDATE_METHOD}</p>
  </details>;
}
