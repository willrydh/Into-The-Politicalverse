...
export function CandidateRankings() {
  ...
  const metrics: {id:RankingMetric;name:string;shortName:string;detail:string}[]=[
    ...
    {id:"support",name:sv?"Stöd längre ned":"Support down the ballot",shortName:sv?"Stöd längre ned":"Down the ballot",detail:sv?"Personstöd från listplats 6":"Personal support from position 6"},
  ...
  return <div className="candidate-page candidate-page--rankings">
    ...
    <div className="candidate-body">
      ...
      {metric==="support"&&<p className="candidate-leaderboard-intro">{sv?"Minst 100 personröster. Plats 6 eller lägre på alla redovisade valsedlar i området. Rangordnat efter andel av partiets röster — inte ett betyg på politiskt arbete eller ett mått där listplatsens effekt räknats bort.":"At least 100 personal votes. Position 6 or lower on every reported ballot in the area. Ranked by share of party votes — not a rating of political work or a measure adjusted for the effect of ballot position."}</p>}
