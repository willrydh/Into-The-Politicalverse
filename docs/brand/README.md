...
The replacement starts with ordinary document flow. Upward scrolling floats the same opaque header at the top, including its safe-area padding. Downward movement releases it into the document at its current position so the browser scrolls it away directly. Once outside the viewport, it returns to its original place, hidden and inert; no fixed/sticky box remains at the top while reading. The placeholder only preserves document height and is never fixed, transformed, hidden or painted. Keyboard access, mobile menu pinning and reduced motion remain available.
