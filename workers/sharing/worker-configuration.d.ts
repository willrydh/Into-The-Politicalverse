/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/sharing/wrangler.jsonc workers/sharing/worker-configuration.d.ts` (hash: a984d8f0bd293c640594268a5c0e5e8e)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SITE_ORIGIN">> {}
}
declare module "*.woff" {
