/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/insights/wrangler.jsonc workers/insights/worker-configuration.d.ts` (hash: ccf42cff2f060498bf7c34560629e271)
// Runtime types generated with workerd@1.20260907.1 2026-09-08 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	SITE_ORIGIN: "https://politicalverse.se";
	GA_MEASUREMENT_ID: "";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SITE_ORIGIN" | "GA_MEASUREMENT_ID">> {}
}
declare module "*.html" {
	const value: string;
