  ...
  return localizeNode((
    <div className="interior-page simulator-page">
      ...
      <section className="simulator-methodology" aria-labelledby="simulator-method-title">
        <div>
          <p className="eyebrow">Method · pv-riksdag-scenario v1.2.0</p>
        ...
        <div className="simulator-method-grid">
          ...
          <article><span>02</span><h3>Geographic projection</h3><p>Scenarier börjar i det fastställda valresultatets fördelning mellan valkretsarna. När du ändrar en andel behålls partiets geografiska mönster från den resultatversionen.</p></article>
          ...
          <article><span>04</span><h3>Not a forecast</h3><p>Utgångsläget återger det fastställda valresultatet. Ett ändrat scenario är din egen beräkning och påverkar inte de officiella resultaten.</p></article>
        </div>
