...
export const metadata: Metadata = { title: "Valnatten 2026", description: "Officiell rösträkning från Valmyndigheten, med separata räkningstillfällen och synliga källtider." };
