  ...
  return localizeNode((
    <div className="interior-page">
      <header className="interior-hero interior-hero--map">
        ...
        <div className="interior-hero__context"><p className="interior-hero__deck">{locale === "sv" ? "Se riksdags-, region- och kommunvalet 2026 med jämförelser mot 2022. Klicka dig från län till kommun och valdistrikt. Växla parti, mått och valår." : "Explore the 2026 parliamentary, regional and municipal elections with 2022 comparisons. Explore counties, municipalities and electoral districts. Switch party, measure and election year."}</p><DataSource compact year={2026} /></div>
      </header>
