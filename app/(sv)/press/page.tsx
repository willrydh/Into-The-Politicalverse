...
const copy = {
  sv: {
    ...
    updates: [
      ...
      { title: "Valnatten och efterräkningen 2026", text: "Resultathämtningen kontrollerar publicerade filer ungefär var femte minut den 13–30 september, följt av dagliga kontroller av slutliga protokoll och rättelser under oktober–december. Startsidan visar räknade officiella röster. Prognossidan, valnattsmodellen och simulatorns utgångsläge följer samma verifierade modell, separat från resultatet. Kommun- och regionresultat uppdateras i samma hämtning. Webbläsaren kontrollerar den publicerade filen varje minut. Nya siffror beror på myndighetens publicering och kan fördröjas." },
  ...
  en: {
    ...
    updates: [
      ...
      { title: "Election night and the final count in 2026", text: "Result collection checks published files approximately every five minutes from 13–30 September, followed by daily checks for final protocols and corrections during October–December. The homepage shows officially counted votes. The forecast page, election-night model and simulator starting point share one verified model, separate from the result. Municipal and regional results are updated in the same collection cycle. The browser checks the published file every minute. New figures depend on the authority’s publications and may be delayed." },
