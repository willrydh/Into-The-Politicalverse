...
const copy = {
  sv: {
    ...
    features: [
      ...
      { title: "Utforska valen på kartan", href: "/maps/", text: "Gå från län till kommun och valdistrikt. Se 2026 års riksdags-, region- och kommunval med årets gränser och jämförelser mot 2022. Personröster visas för det valområde som källan faktiskt redovisar." },
      { title: "Förstå prognosen", href: "/forecasts/", text: "Jämför den frysta prognosen före valet med det fastställda utfallet. Metod och källtid är synliga. Simulatorn börjar i det verifierade valresultatet; egna scenarier hålls åtskilda från officiella röster." },
    ...
    sources: [
      { name: "Valmyndigheten", href: "https://www.val.se/", text: "Officiella valresultat, personröster, kandidatlistor och listplatser, mandat och valgeografi. För 2026 är signerade resultat anslutna för riksdagen, samtliga 20 regionval och samtliga 290 kommunval, med jämförelser mot 2022. Fastställda personröster från 2026 förs automatiskt in i profiler, topplistor och delningsbilder efter kontroll av röster, listplatser, områden och personkopplingar. Täckningen visas per val." },
      { name: "SwedishPolls och mätinstituten", href: "https://github.com/MansMeg/SwedishPolls", text: "Förvalsprognosens opinionsunderlag hämtas från SwedishPolls sammanställning. Utvalda observationer kontrolleras mot institutens originalpubliceringar och exempelvis SVT och Sveriges Radio. Mätningar, publiceringsdatum och kontroller redovisas i prognosens metodavsnitt." },
    ...
    updates: [
      ...
      { title: "Valnatten och efterräkningen 2026", text: "Resultathämtningen kontrollerar publicerade filer ungefär var femte minut den 13–30 september, följt av dagliga kontroller av slutliga protokoll och rättelser under oktober–december. Startsidan visar räknade officiella röster. När resultatet fastställs ersätter det valnattsmodellen i de aktuella vyerna och simulatorns utgångsläge. Den frysta förvalsprognosen finns kvar för jämförelse. Kommun- och regionresultat uppdateras i samma hämtning. Webbläsaren kontrollerar den publicerade filen varje minut. Nya siffror beror på myndighetens publicering och kan fördröjas." },
    ...
    readiness: "De publicerade resultatfilerna kontrolleras för signaturer, identitet, röstsummor och mandat. Den 14 september var alla 311 preliminära valområden anslutna. En ny sluträkningsfas ersätter inte den preliminära resultatbilden förrän hela valområdet är rapporterat. En fullständig utvärdering av prognosfelet visas först när det slutliga resultatet är komplett.",
  ...
  en: {
    ...
    features: [
      ...
      { title: "Explore elections on the map", href: "/maps/", text: "Move from counties to municipalities and electoral districts. Explore the 2026 parliamentary, regional and municipal elections with current boundaries and 2022 comparisons. Personal votes retain the electoral area actually reported by the source." },
      { title: "Understand the forecast", href: "/forecasts/", text: "Compare the frozen pre-election forecast with the final outcome. Methodology and source time are visible. The simulator starts from the verified election result; custom scenarios remain separate from official votes." },
    ...
    sources: [
      { name: "Swedish Election Authority", href: "https://www.val.se/", text: "Official election results, personal votes, candidate lists and ballot positions, seats and electoral geography. For 2026, signed results are connected for the Riksdag, all 20 regional elections and all 290 municipal elections, with 2022 comparisons. Final 2026 personal votes automatically enter profiles, leaderboards and sharing images after checks of votes, ballot positions, areas and identity links. Coverage is shown for each election." },
      { name: "SwedishPolls and polling organisations", href: "https://github.com/MansMeg/SwedishPolls", text: "The pre-election forecast’s polling inputs come from the SwedishPolls compilation. Selected observations are cross-checked against original pollster publications and outlets including SVT and Sveriges Radio. Polls, publication dates and checks are documented in the forecast methodology." },
    ...
    updates: [
      ...
      { title: "Election night and the final count in 2026", text: "Result collection checks published files approximately every five minutes from 13–30 September, followed by daily checks for final protocols and corrections during October–December. The homepage shows officially counted votes. Once established, the official result replaces the election-night model in current views and the simulator starting point. The frozen pre-election forecast remains available for comparison. Municipal and regional results are updated in the same collection cycle. The browser checks the published file every minute. New figures depend on the authority’s publications and may be delayed." },
    ...
    readiness: "Published files are checked for signatures, identity, vote totals and mandates. All 311 preliminary electoral areas were connected on 14 September. A new final-count phase replaces the preliminary overall result only once the whole electoral area is reported. A full assessment of forecast error is shown only when the final result is complete.",
