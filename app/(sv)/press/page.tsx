...
const copy = {
  sv: {
    ...
    updates: [
      ...
      { title: "Valnatten och efterräkningen 2026", text: "Resultathämtningen är förberedd för kontroller ungefär var femte minut den 13–30 september, följt av dagliga kontroller av slutliga protokoll och rättelser under oktober–december. Startsidan, prognossidan, valnattsidan och simulatorns utgångsläge följer samma verifierade valnattsmodell. Webbläsaren kontrollerar den publicerade filen varje minut. Nya siffror beror på myndighetens publicering och kan fördröjas." },
  ...
  en: {
    ...
    updates: [
      ...
      { title: "Election night and the final count in 2026", text: "Result collection is prepared for checks approximately every five minutes from 13–30 September, followed by daily checks for final protocols and corrections during October–December. The homepage, forecast page, election-night page and simulator starting point follow the same verified election-night model. The browser checks the published file every minute. New figures depend on the authority’s publications and may be delayed." },
