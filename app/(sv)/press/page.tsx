...
const copy = {
  sv: {
    ...
    features: [
      ...
      { title: "Förstå prognosen", href: "/forecasts/", text: "Se löpande röstandelar, mandat, känslighetsspann och majoritetsscenarier från valnattsmodellen. Metod och källtid är synliga. Simulatorn börjar i samma prognos; förvalsprognosen finns kvar i arkivet." },
    ...
    sources: [
      { name: "Valmyndigheten", href: "https://www.val.se/", text: "Officiella valresultat, personröster, kandidatlistor och listplatser, mandat och valgeografi. För 2026 är signerade resultat anslutna för riksdagen, samtliga 20 regionval och samtliga 290 kommunval, med jämförelser mot 2022. Personröster för det nya valet införs efter en separat granskning." },
  ...
  en: {
    ...
    features: [
      ...
      { title: "Understand the forecast", href: "/forecasts/", text: "Explore live vote shares, seats, sensitivity ranges and majority scenarios from the election-night model. Methodology and source time are visible. The simulator starts from the same projection; the pre-election forecast remains in the archive." },
    ...
    sources: [
      { name: "Swedish Election Authority", href: "https://www.val.se/", text: "Official election results, personal votes, candidate lists and ballot positions, seats and electoral geography. For 2026, signed results are connected for the Riksdag, all 20 regional elections and all 290 municipal elections, with 2022 comparisons. Personal votes for the new election require a separate review before publication." },
