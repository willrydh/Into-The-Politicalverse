...
const sources = [
  ...
  { name: "Valresultat 2026 · riksdag, region och kommun", status: "Ansluten · 311 valområden", format: "JSON · ZIP · RSA/SHA-256", use: "Signerade resultat för riksdagen, 20 regionval och 290 kommunval. Riksdagens 29 valkretsar och kommunresultat, regionernas kommunresultat samt jämförelser med 2022. Preliminär och slutlig räkning kontrolleras oberoende.", url: "https://www.val.se/valresultat-och-statistik/statistik-och-data/teknisk-beskrivning-av-resultatfiler" },
  ...
  { name: "Kandidaturer och personröster 2026", status: "Nästa steg · personröstintag", format: "CSV + JSON", use: "Kandidaturer är inte personröster. De preliminära resultatfilerna saknar personröster. Sluträkningsfilerna bevakas, men 2026 aktiveras i profiler och topplistor först efter kontroll av källtäckning, listplatser, geografi och personkopplingar.", url: rawPage },
  ...
  { name: "Valforskningsprogrammet och historiska SVT Valu", status: "Forsknings- och jämförelsekällor", format: "Rapporter · historiska undersökningar", use: "Väljarundersökningar, metodrapporter och historiska vallokalsundersökningar. Valu 2026 redovisas separat som en undersökning på valnattsidan.", url: "https://www.gu.se/valforskningsprogrammet/undersokningar/valundersokningar" },
  { name: "SVT Valu 2026", status: "Publicerad · återkontrollerad 14 september", format: "POLL · nationell vallokalsundersökning", use: "Partisiffror från SVT:s Valu-data, med källänk och hämtningstid. En granskad ögonblicksbild som hålls separat från räknade röster och våra prognoser.", url: "https://www.svt.se/datajournalistik/val2026/pussla-ihop-sveriges-regering/" },
];

export default function SourcesPage({ locale = "sv" }: { locale?: Locale } = {}) {
  return localizeNode(<div className="product-section source-catalog"><header className="source-hero"><p className="eyebrow eyebrow--dark">Källregister · uppdaterat 14 september 2026</p><h1>Fler källor. Tydliga gränser.</h1><p>Här syns vad som är anslutet, vad som har provats och vad som finns tillgängligt för nästa steg. Varje datatyp har sin egen betydelse och uppdateringstakt.</p></header>
