...
const sources = [
  ...
  { name: "SVT Valu 2026", status: "Publicerad · kontrollerad 13 september", format: "POLL · nationell vallokalsundersökning", use: "Partisiffror från SVT:s Valu-data, med källänk och hämtningstid. En granskad ögonblicksbild som hålls separat från räknade röster och våra prognoser.", url: "https://www.svt.se/datajournalistik/val2026/pussla-ihop-sveriges-regering/" },
];

export default function SourcesPage({ locale = "sv" }: { locale?: Locale } = {}) {
  return localizeNode(<div className="product-section source-catalog"><header className="source-hero"><p className="eyebrow eyebrow--dark">Källregister · Valu tillagd 13 september 2026</p><h1>Fler källor. Tydliga gränser.</h1><p>Här syns vad som är anslutet, vad som har provats och vad som finns tillgängligt för nästa steg. Varje datatyp har sin egen betydelse och uppdateringstakt.</p></header>
