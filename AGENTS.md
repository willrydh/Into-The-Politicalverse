...
- Candidate sharing metadata and PNGs use the same profile selection and verified final history as the page. Preserve source/content revisions, dynamic election years, scope, null/zero distinctions and cache invalidation on new elections or corrected counts. Never pull staged or preliminary results into final-result cards. See `docs/operations/candidate-sharing.md`.
