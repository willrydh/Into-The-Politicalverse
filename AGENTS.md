...
- Missing vote comparisons use a dash in cells, with the specific reason in its accessible label and a concise visible footnote below affected tables. Never repeat explanatory sentences inside narrow numeric columns; preserve numeric deltas and null/zero distinctions.
