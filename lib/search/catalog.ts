...
export const SEARCH_PAGES = [
  ...
  { route: "people", title: b("Kandidatprofiler och personhistorik", "Candidate profiles and histories"), description: b("Personröster och partikandidaturer över valen 2010–2026.", "Personal votes and party candidacies across the 2010–2026 elections.") },
  { route: "", title: b("Start · Valresultat 2026", "Home · Election results 2026"), description: b("Räknade röster, röstandelar och rapporterade mandat i riksdagsvalet 2026.", "Counted votes, vote shares and reported seats in the 2026 Riksdag election.") },
  { route: "forecasts", title: b("Prognos 2026", "Forecast 2026"), description: b("Fastställt valresultat, mandat och jämförelse med den frysta prognosen före valet.", "Final election result, seats and comparison with the frozen pre-election forecast.") },
...
const topics = [
  ["personal", "/maps/?year=2026#personal-votes", "Personröster och kandidater", "Personal votes and candidates", "Personval, kandidatlistor, utlandsröster och femprocentspärren i riksdagsvalkretsen.", "Personal voting, candidate lists, overseas votes and the five-percent constituency threshold."],
  ["questions", "/forecasts/#valnattsprognos", "Prognosfrågor", "Forecast questions", "Största parti, riksdagsspärren och koalitionernas mandat.", "Largest party, parliamentary threshold and coalition seats."],
  ["seats", "/forecasts/#valnattsprognos", "Valnattens röster och mandat", "Election-night votes and seats", "Partiernas osäkerhet och fördelning av mandat.", "Party uncertainty and distribution of seats."],
  ...
  ["history", "/forecasts/#archive-historik", "Förvalsprognosens utveckling · arkiv", "Pre-election forecast history · archive", "Hur mandatprognosen har förändrats över tid.", "How the seat forecast has changed over time."],
  ["backtest", "/forecasts/#metod", "Historisk kontroll av prognosen", "Historical forecast validation", "Backtest, kalibrering och historiska prognosfel.", "Backtesting, calibration and historical forecast errors."],
  ["method", "/forecasts/#metod", "Prognosmetod och dataintegritet", "Forecast methodology and data integrity", "Jämförbara distrikt, geografiska förändringar, Monte Carlo-simuleringar, källor och begränsningar.", "Comparable districts, geographic swings, Monte Carlo simulations, sources and limitations."],
