...
export const SEARCH_PAGES = [
  ...
  { route: "forecasts", title: b("Prognos 2026", "Forecast 2026"), description: b("Löpande valnattsprognos, mandat och regeringsbildning. Förvalsprognosen finns i arkivet.", "Live election-night projection, seats and government formation. The pre-election forecast remains in the archive.") },
