...
const topics = [
  ...
  ["method", "/forecasts/#metod", "Prognosmetod och dataintegritet", "Forecast methodology and data integrity", "Jämförbara distrikt, geografiska förändringar, simuleringar, källor och begränsningar.", "Comparable districts, geographic swings, simulations, sources and limitations."],
