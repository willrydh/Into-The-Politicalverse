...
export const ROUTES = ["", "forecasts", "charts", "parties", "maps", "elections", "indicators", "simulator", "overview", "valnatt", "sources", "search", "rankings", "people", "press", "privacy"] as const;
